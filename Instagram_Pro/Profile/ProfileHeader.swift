...
class ProfileHeader: UICollectionViewCell {
    ...
    fileprivate func setupFollowStyle() {
        ...
        self.editProfileFollowButton.backgroundColor = UIColor.quickSetRGB(red: 17, green: 154, blue: 237)
    ...
    fileprivate func setupProfileimageView() {
        ...
        profileImageView.quickSetAnchor(top: topAnchor, left: self.leftAnchor, bottom: nil, right: nil, paddingTop: 12, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 80, height: 80)
    ...
    fileprivate func setupUsernameLabel() {
        ...
        usernameLabel.quickSetAnchor(top: profileImageView.bottomAnchor, left: leftAnchor,bottom: bottomAnchor,  right: rightAnchor, paddingTop: -16, paddingLeft: 16, paddingBottom: 0, paddingRight: 12, width: 0, height: 0)
    }
    
    fileprivate func setupButton() {
        addSubview(editProfileFollowButton)
        editProfileFollowButton.quickSetAnchor(top: postsLabel.bottomAnchor, left: postsLabel.leftAnchor, bottom: nil, right: followingLabel.rightAnchor, paddingTop: 2, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 34)
    }
    ...
    fileprivate func setupUserStatsView() {
        ...
        stackView.quickSetAnchor(top: topAnchor, left: profileImageView.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 12, paddingLeft: 12, paddingBottom: 0, paddingRight: 12, width: 0, height: 50)
    }
