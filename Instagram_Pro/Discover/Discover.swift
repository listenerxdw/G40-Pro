...
//  Instagram_Pro
//
//  Created by Yunyi Zhang on 2018/10/17.
...
class Discover:  UICollectionViewController, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    lazy var searchBar: UISearchBar = {
        ...
        UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).backgroundColor = UIColor.quickSetRGB(red: 230, green: 230, blue: 230)
        sb.delegate = self
        return sb
    }()
    ...
    override func viewDidLoad() {
        ...
        searchBar.quickSetAnchor(top: navBar?.topAnchor, left: navBar?.leftAnchor, bottom: navBar?.bottomAnchor, right: navBar?.rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 8, width: 0, height: 0)
